...
// ========== Context ==========
Data::Data(std::vector<int> *data) : data(data) { this->strategy = nullptr; }
...
Data::Data(Data &rhs) : strategy(std::move(rhs.strategy)), data(rhs.data) {}
...
void Data::doAlgorithm(std::vector<int> *data) { strategy->doAlgorithm(data); }
