...
class Car {
public:
  explicit Car(const std::string &make = "N/A",
               const std::string &model = "N/A");
  ~Car();
...
public:
  explicit ConcreteCarBuilder(const std::string &make = "N/A",
                              const std::string &model = "N/A");
  ~ConcreteCarBuilder() override;

  // ============ car constructors ============
  void CreateCar(const std::string &make = "N/A",
                 const std::string &model = "N/A");
...
public:
  ...
  // functions that help create a "recipe" for the director to trigger the
  // builder
