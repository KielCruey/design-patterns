...
Car::~Car() { std::cout << "Deconstructor -- Car" << std::endl; }

void Car::printMake() const { std::cout << "Make: " + GetMake() << std::endl; }
...
// ============ Concrete Builder ============
ConcreteCarBuilder::ConcreteCarBuilder(const std::string &make,
                                       const std::string &model) {
  this->CreateCar(make, model);
}

ConcreteCarBuilder::~ConcreteCarBuilder() { delete this->car; }

void ConcreteCarBuilder::CreateCar(const std::string &make,
                                   const std::string &model) {
...
static void SeasonalProjectCars(CarDirector *carDirector) {
  ...
  // director calls what type of car 'setting' it should have once assigned a
  // concreteCarBuilder as parameter
  ...
  // creating a Car object and assigning the Car object to the "favor" of car
  // created but the concreteCarBuilder
