...
// ============== RobotPrototype ==============
RobotPrototype::RobotPrototype(int serialNumber) : serialNumber(serialNumber) {
...
ConcreteCivilianRobotPrototype::ConcreteCivilianRobotPrototype(
    int serialNumber, const std::string &name)
    : RobotPrototype(serialNumber), name(name) {
...
void ConcreteCivilianRobotPrototype::PrintInfo() {
  std::cout << "Concrete Civilian Robot is named " + GetName() +
                   " with the serial number "
            << GetSerialNumber() << "." << std::endl;
}

RobotPrototype *ConcreteCivilianRobotPrototype::Clone() const {
  return new ConcreteCivilianRobotPrototype(
      *this); // calling default copy constructor -- shallow copy only
}

// ============== ConcreteMilitaryRobotPrototype ==============
ConcreteMilitaryRobotPrototype::ConcreteMilitaryRobotPrototype(
    int serialNumber, const std::string &rank)
    : RobotPrototype(serialNumber), rank(rank) {
...
void ConcreteMilitaryRobotPrototype::PrintInfo() {
  std::cout << "Concrete Military Robot rank is " + GetRank() +
                   " with the serial number "
            << GetSerialNumber() << "." << std::endl;
}

RobotPrototype *ConcreteMilitaryRobotPrototype::Clone() const {
  return new ConcreteMilitaryRobotPrototype(
      *this); // calling default copy constructor -- shallow copy only
}

// ============== Factory ==============
PrototypeFactory::PrototypeFactory() {
  robotMap[RobotTypes::CIVILIAN] =
      new ConcreteCivilianRobotPrototype(0, "No Name");
  robotMap[RobotTypes::MILITARY] =
      new ConcreteMilitaryRobotPrototype(0, "No Rank");
}
...
// ============== Client Code ==============
static RobotPrototype *
CloneAndPrintMilitaryRobot(ConcreteMilitaryRobotPrototype const *mRobot) {
...
static RobotPrototype *
CloneAndPrintCivilianRobot(ConcreteCivilianRobotPrototype const *cRobot) {
...
static void SimpleMiliaryClone() {
  ConcreteMilitaryRobotPrototype *mRobot =
      new ConcreteMilitaryRobotPrototype(123, "Private");
  mRobot->PrintInfo();
...
static void SimpleCivilianClone() {
  ConcreteCivilianRobotPrototype *cRobot =
      new ConcreteCivilianRobotPrototype(321, "Dawn");
  cRobot->PrintInfo();
...
int main() {
  ...
  ConcreteCivilianRobotPrototype *rJim =
      new ConcreteCivilianRobotPrototype(9, "Jim");
  ConcreteMilitaryRobotPrototype *rBob =
      new ConcreteMilitaryRobotPrototype(888, "General");
