...
// =========== Outlet ===========
Outlet::Outlet(bool HasRoundHoles, int NumberOfHoles, int VoltageRating,
               int FrequencyRating)
    : HasRoundHoles(HasRoundHoles), NumberOfHoles(NumberOfHoles),
      VoltageRating(VoltageRating), FrequencyRating(FrequencyRating) {
  std::cout << "Outlet Created" << std::endl;
}

Outlet::~Outlet() { std::cout << "Outlet deleted" << std::endl; }

// =========== AmericanOutlet ===========
AmericanOutlet::AmericanOutlet(int VoltageRating, int FrequencyRating,
                               bool HasRoundHoles, int NumberOfHoles)
...
// =========== UKOutlet ===========
UKOutlet::UKOutlet(int VoltageRating, int FrequencyRating, bool HasRoundHoles,
                   int NumberOfHoles)
    : Outlet(HasRoundHoles, NumberOfHoles, VoltageRating, FrequencyRating) {
  std::cout << "UKOutlet created" << std::endl;
}

UKOutlet::~UKOutlet() { std::cout << "UKOutlet deleted" << std::endl; };

// =========== JapaneseOutlet ===========
JapaneseOutlet::JapaneseOutlet(int VoltageRating, int FrequencyRating,
                               bool HasRoundHoles, int NumberOfHoles)
    : Outlet(HasRoundHoles, NumberOfHoles, VoltageRating, FrequencyRating) {
...
// =========== Plug ===========
Plug::Plug(int PinCount, bool HasRoundPins, int VoltageRating,
           int FrequencyRating)
    : PinCount(PinCount), HasRoundPins(HasRoundPins),
      VoltageRating(VoltageRating), FrequencyRating(FrequencyRating) {
  std::cout << "Plug created" << std::endl;
}

Plug::~Plug() { std::cout << "Plug deleted" << std::endl; }

// =========== AmericanPlug ===========
AmericanPlug::AmericanPlug(int VoltageRating, int FrequencyRating, int PinCount,
                           bool HasRoundPins)
...
// =========== UKPlug ===========
UKPlug::UKPlug(int VoltageRating, int FrequencyRating, int PinCount,
               bool HasRoundPins)
    : Plug(PinCount, HasRoundPins, VoltageRating, FrequencyRating) {
  std::cout << "UK plug created" << std::endl;
}

UKPlug::~UKPlug() { std::cout << "UK plug destroyed" << std::endl; }

// =========== JapanesePlug ===========
JapanesePlug::JapanesePlug(int VoltageRating, int FrequencyRating, int PinCount,
                           bool HasRoundPins)
    : Plug(PinCount, HasRoundPins, VoltageRating, FrequencyRating) {
...
Adapter::~Adapter() { std::cout << "Adapter deleted" << std::endl; }
...
Plug *Adapter::GetPlug() { return this->pPlug; }
