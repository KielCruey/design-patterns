...
// complex objects of a composition. In this case, it's a base for the 'leaf'
...
public:
  explicit Part(std::string &brandName, std::string &modelName);
  ~Part();
...
public:
  explicit Mouse(std::string &brandName, std::string &modelName,
                 int dpi = 1000);
  ~Mouse();
...
public:
  explicit Keyboard(bool hasClickyKeys = false, std::string brandName = "N/A",
...
public:
  explicit RAM(double capacity = 0, std::string brandName = "N/A",
...
public:
  explicit CPU(int cores = 0, std::string brandName = "N/A",
               std::string modelName = "N/A");
  ~CPU();
...
public:
  explicit GPU(double memory = 0, std::string brandName = "N/A",
               std::string modelName = "N/A");
  ~GPU();
