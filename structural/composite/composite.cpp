...
// --------------- virtuals ---------------
bool ComputerComponent::IsComposite() { return false; }
...
Part::~Part() { std::cout << "Part destroyed" << std::endl; }
...
// --------------- virtuals ---------------
bool Part::IsComposite() { return false; }
...
Mouse::Mouse(std::string &brandName, std::string &modelName, int dpi)
    : Part(brandName, modelName), dpi(dpi) {
  std::cout << "Mouse created" << std::endl;
}

Mouse::~Mouse() { std::cout << "Mouse destroyed" << std::endl; }

// ------ virtuals ------
bool Mouse::IsComposite() { return false; }
...
Keyboard::Keyboard(bool hasClickyKeys, std::string brandName,
                   std::string modelName)
    : Part(brandName, modelName), hasClickyKeys(hasClickyKeys) {
  std::cout << "Keyboard created" << std::endl;
}

Keyboard::~Keyboard() { std::cout << "Keyboard destroyed" << std::endl; }

// ------ virtuals ------
bool Keyboard::IsComposite() { return false; }
...
Monitor::Monitor(double length, double width, std::string brandName,
                 std::string modelName)
    : Part(brandName, modelName), length(length), width(width) {
  std::cout << "Monitor created" << std::endl;
}

Monitor::~Monitor() { std::cout << "Monitor deleted" << std::endl; }

// ------ virtuals ------
bool Monitor::IsComposite() { return false; }
...
Speakers::Speakers(bool isPowered, int volume, std::string brandName,
                   std::string modelName)
    : Part(brandName, modelName), isPowered(isPowered), volume(volume) {
  std::cout << "Speakers created" << std::endl;
}

Speakers::~Speakers() { std::cout << "Speakers destroyed" << std::endl; }

// ------ virtuals ------
bool Speakers::IsComposite() { return false; }
...
// ============= Concrete Leaf -- SSD =============
SSD::SSD(double currentStorage, double totalStorage, std::string brandName,
         std::string modelName)
    : Part(brandName, modelName), currentStorage(currentStorage),
      totalStorage(totalStorage) {
  std::cout << "SSD created" << std::endl;
}

SSD::~SSD() { std::cout << "SSD destroyed" << std::endl; }

// ------ virtuals ------
bool SSD::IsComposite() { return false; }
...
// ============= Concrete Leaf -- RAM =============
RAM::RAM(double capacity, std::string brandName, std::string modelName)
    : Part(brandName, modelName), capacity(capacity) {
  std::cout << "RAM created" << std::endl;
}

RAM::~RAM() { std::cout << "RAM destroyed" << std::endl; }

// ------ virtuals ------
bool RAM::IsComposite() { return false; }
...
// ============= Concrete Leaf -- CPU =============
CPU::CPU(int cores, std::string brandName, std::string modelName)
    : Part(brandName, modelName), cores(cores) {
  std::cout << "CPU created" << std::endl;
}

CPU::~CPU() { std::cout << "CPU destroyed" << std::endl; }

// ------ virtuals ------
bool CPU::IsComposite() { return false; }
...
// ============= Concrete Leaf -- GPU =============
GPU::GPU(double memory, std::string brandName, std::string modelName)
    : Part(brandName, modelName), memory(memory) {
  std::cout << "GPU created" << std::endl;
}

GPU::~GPU() { std::cout << "GPU destroyed" << std::endl; }

// ------ virtuals ------
bool GPU::IsComposite() { return false; }
...
bool Computer::IsComposite() { return true; }
...
// this Composite class adds an object to its list and assigns that object to
...
// this Composite class deletes an object from its list and removes that object
...
bool Peripherals::IsComposite() { return true; }
...
// ============= Tower -- Composite =============
Tower::Tower() { std::cout << "Tower composite object created" << std::endl; }
...
bool Tower::IsComposite() { return true; }
...
bool Motherboard::IsComposite() { return true; }
