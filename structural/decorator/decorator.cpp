...
Entity::Entity(int health, int mana, int fatigue)
    : health(health), mana(mana), fatigue(fatigue) {
...
Knight::~Knight() { std::cout << "Knight destroyed" << std::endl; }

void Knight::EquipArmor() { std::cout << "Armor equipped" << std::endl; }

void Knight::EquipGreaves() { std::cout << "Greaves equipped" << std::endl; }

void Knight::EquipHelmet() { std::cout << "Helmet equipped" << std::endl; }

void Knight::EquipMainHand() { std::cout << "Sword equipped" << std::endl; }

void Knight::EquipSecondaryHand() {
  std::cout << "Shield equipped" << std::endl;
}

void Knight::EquipSabaton() { std::cout << "Sabatons equipped" << std::endl; }
...
void Knight::Reload() { std::cout << "Knight don't reload!" << std::endl; }

// =========== Archer ===========
Archer::Archer(int arrowsEquip, int health, int mana, int fatigue)
    : arrowsEquip(arrowsEquip), Entity(health, mana, fatigue) {
  std::cout << "Archer created" << std::endl;
}

Archer::~Archer() { std::cout << "Archer destroyed" << std::endl; }

void Archer::EquipArmor() { std::cout << "Armor equipped" << std::endl; }

void Archer::EquipGreaves() { std::cout << "Greaves equipped" << std::endl; }

void Archer::EquipHelmet() { std::cout << "Helmet equipped" << std::endl; }

void Archer::EquipMainHand() { std::cout << "Bow equipped" << std::endl; }

void Archer::EquipSecondaryHand() {
  std::cout << "Arrows equipped" << std::endl;
}

void Archer::EquipSabaton() { std::cout << "Sabatons equipped" << std::endl; }
...
HolyKnight::HolyKnight(Entity *entity, int faithMagic)
    : EntitySpecialization(entity), faithMagic(faithMagic) {
  std::cout << "Holy Knight created" << std::endl;
}

HolyKnight::~HolyKnight() { std::cout << "Holy Knight destroyed" << std::endl; }
...
DarkKnight::DarkKnight(Entity *entity, int darkMagic)
    : EntitySpecialization(entity), darkMagic(darkMagic) {
  std::cout << "Dark Knight created" << std::endl;
}

DarkKnight::~DarkKnight() { std::cout << "Dark Knight destroyed" << std::endl; }
...
CrossBowArcher::CrossBowArcher(Entity *entity, int finessePoints)
    : EntitySpecialization(entity), finessePoints(finessePoints) {
