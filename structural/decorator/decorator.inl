// =========== Entity ===========
inline int Entity::GetFatigue() const { return this->fatigue; }

// =========== Archer ===========
inline int Archer::GetArrowsEquip() const { return this->arrowsEquip; }
...
inline Entity *EntitySpecialization::GetEntity() const { return this->entity; }

// =========== Holy Knight ===========
inline int HolyKnight::GetFaithMagic() const { return this->faithMagic; }
...
// =========== Dark Knight ===========
inline int DarkKnight::GetDarkMagic() const { return this->darkMagic; }
