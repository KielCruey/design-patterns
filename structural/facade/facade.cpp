...
// ======== Waiter ========
Waiter::Waiter() { std::cout << "Waiter created" << std::endl; }

Waiter::~Waiter() { std::cout << "Waiter destroyed" << std::endl; }

void Waiter::CleansTable() { std::cout << "Waiter cleans tables" << std::endl; }
...
// ======== Chef ========
Chef::Chef() { std::cout << "Chef created" << std::endl; }

Chef::~Chef() { std::cout << "Chef destroyed" << std::endl; }

void Chef::PreparesFood() { std::cout << "Chef prepares food" << std::endl; }

void Chef::CutsFood() { std::cout << "Chef cuts food" << std::endl; }

void Chef::CooksFood() { std::cout << "Chef cooks food" << std::endl; }

void Chef::PlatesFood() { std::cout << "Chef plates food" << std::endl; }

void Chef::OrderReady() {
  std::cout << "'Order is Ready' the Chef yells" << std::endl;
}

void Chef::WashesDishes() { std::cout << "Chef washes dishes" << std::endl; }

// ======== FrontOfHouse ========
FrontOfHouse::FrontOfHouse(Waiter *waiter) : waiter(waiter) {
...
// ======== BackOfHouse ========
BackOfHouse::BackOfHouse(Chef *chef) : chef(chef) {
...
// ======== Customer ========
Customer::Customer() { std::cout << "Customer created" << std::endl; }

Customer::~Customer() { std::cout << "Customer destroyed" << std::endl; }
...
void Customer::GoesToTable() { std::cout << "Customer is seated" << std::endl; }
...
void Customer::PaysBill() { std::cout << "Customer pays bill" << std::endl; }
...
RestaurantFacade::RestaurantFacade(FrontOfHouse *frontOfHouse,
                                   BackOfHouse *backOfHouse)
    : frontOfHouse(frontOfHouse), backOfHouse(backOfHouse) {
...
void RestaurantFacade::RemoveCustomer() { GetCustomerQueue().pop(); }

// ========== Client Code ==========
Waiter *CreateWaiter() { return new Waiter(); }

Chef *CreateChef() { return new Chef(); }

Customer *CreateCustomer() { return new Customer(); }

void ServeCustomers(RestaurantFacade *restaurant, Customer *girlfriend,
                    Customer *boyfriend) {
...
int main() {
  ...
  RestaurantFacade *restaurant =
      new RestaurantFacade(frontOfHouse, backOfHouse);
